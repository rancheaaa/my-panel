...
public class DictUtils
{
    ...
    {
        return SpringUtils.getBean(ISysDictTypeService.class).selectDictDataByType(key);
    }
    ...
    {
        Cache cache = SpringUtils.getBean(CacheManager.class).getCache(CacheConstants.SYS_DICT_KEY);
        if (cache != null)
        {
            cache.evict(key);
        }
