...
public class RcProjectServiceImpl implements IRcProjectService 
{
    ...
    {
        rcProject.setCreateTime(MyDateUtils.getNowDate());
    ...
    {
        rcProject.setUpdateTime(MyDateUtils.getNowDate());
    ...
    {
        Long id = MyStringUtils.isNull(rcProject.getId()) ? -1L : rcProject.getId();
