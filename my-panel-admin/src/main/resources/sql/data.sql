...
(1, 'server', '服务器', 'server', 'infrastructure', 120, 80, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"cpu":"4核","memory":"8GB","disk":"100GB","rotation":0}', '1', '1', 1, 'admin', NOW(), 'admin', NOW(), '0', '基础设施-服务器'),
(2, 'vm', '虚拟机', 'vm', 'infrastructure', 120, 80, '{"backgroundColor":"#52c41a","borderColor":"#52c41a","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"cpu":"2核","memory":"4GB","disk":"50GB","rotation":0}', '1', '1', 2, 'admin', NOW(), 'admin', NOW(), '0', '基础设施-虚拟机'),
(3, 'container', '容器', 'container', 'infrastructure', 100, 100, '{"backgroundColor":"#13c2c2","borderColor":"#13c2c2","borderWidth":2,"borderRadius":50,"color":"#ffffff"}', '{"image":"nginx:latest","port":80,"rotation":0}', '1', '1', 3, 'admin', NOW(), 'admin', NOW(), '0', '基础设施-容器'),
(4, 'nginx', 'Nginx', 'nginx', 'middleware', 120, 80, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"1.18","port":80,"workers":4,"rotation":0}', '1', '1', 4, 'admin', NOW(), 'admin', NOW(), '0', '中间件-Nginx'),
(5, 'redis', 'Redis', 'redis', 'cache', 120, 80, '{"backgroundColor":"#f5222d","borderColor":"#f5222d","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"6.0","port":6379,"maxMemory":"1GB","rotation":0}', '1', '1', 5, 'admin', NOW(), 'admin', NOW(), '0', '缓存-Redis'),
(6, 'mysql', 'MySQL', 'mysql', 'database', 120, 80, '{"backgroundColor":"#2f54eb","borderColor":"#2f54eb","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"8.0","port":3306,"charset":"utf8mb4","rotation":0}', '1', '1', 6, 'admin', NOW(), 'admin', NOW(), '0', '数据库-MySQL'),
(7, 'mongodb', 'MongoDB', 'mongodb', 'database', 120, 80, '{"backgroundColor":"#52c41a","borderColor":"#52c41a","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"4.4","port":27017,"replicas":3,"rotation":0}', '1', '1', 7, 'admin', NOW(), 'admin', NOW(), '0', '数据库-MongoDB'),
(8, 'rabbitmq', 'RabbitMQ', 'rabbitmq', 'mq', 120, 80, '{"backgroundColor":"#eb2f96","borderColor":"#eb2f96","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"3.8","port":5672,"managementPort":15672,"rotation":0}', '1', '1', 8, 'admin', NOW(), 'admin', NOW(), '0', '消息队列-RabbitMQ'),
(9, 'kafka', 'Kafka', 'kafka', 'mq', 120, 80, '{"backgroundColor":"#722ed1","borderColor":"#722ed1","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"2.8","port":9092,"partitions":3,"rotation":0}', '1', '1', 9, 'admin', NOW(), 'admin', NOW(), '0', '消息队列-Kafka'),
(10, 'springboot', 'SpringBoot', 'springboot', 'application', 120, 80, '{"backgroundColor":"#52c41a","borderColor":"#52c41a","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"2.7","port":8080,"jvm":"-Xmx512m","rotation":0}', '1', '1', 10, 'admin', NOW(), 'admin', NOW(), '0', '应用服务-SpringBoot'),
(11, 'nodejs', 'Node.js', 'nodejs', 'application', 120, 80, '{"backgroundColor":"#faad14","borderColor":"#faad14","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"16.x","port":3000,"framework":"Express","rotation":0}', '1', '1', 11, 'admin', NOW(), 'admin', NOW(), '0', '应用服务-Node.js'),
(12, 'python', 'Python', 'python', 'application', 120, 80, '{"backgroundColor":"#13c2c2","borderColor":"#13c2c2","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"3.9","port":5000,"framework":"Flask","rotation":0}', '1', '1', 12, 'admin', NOW(), 'admin', NOW(), '0', '应用服务-Python'),
(13, 'elasticsearch', 'Elasticsearch', 'elasticsearch', 'middleware', 120, 80, '{"backgroundColor":"#fa541c","borderColor":"#fa541c","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"7.10","port":9200,"nodes":3,"rotation":0}', '1', '1', 13, 'admin', NOW(), 'admin', NOW(), '0', '中间件-Elasticsearch'),
(14, 'prometheus', 'Prometheus', 'prometheus', 'monitor', 120, 80, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"2.30","port":9090,"retention":"15d","rotation":0}', '1', '1', 14, 'admin', NOW(), 'admin', NOW(), '0', '监控-Prometheus'),
(15, 'grafana', 'Grafana', 'grafana', 'monitor', 120, 80, '{"backgroundColor":"#f5222d","borderColor":"#f5222d","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"8.0","port":3000,"datasources":5,"rotation":0}', '1', '1', 15, 'admin', NOW(), 'admin', NOW(), '0', '监控-Grafana'),
(16, 'kubernetes', 'Kubernetes', 'kubernetes', 'infrastructure', 140, 100, '{"backgroundColor":"#326ce5","borderColor":"#326ce5","borderWidth":2,"borderRadius":8,"color":"#ffffff"}', '{"version":"1.22","nodes":5,"pods":100,"rotation":0}', '1', '1', 16, 'admin', NOW(), 'admin', NOW(), '0', '基础设施-Kubernetes'),
(17, 'docker', 'Docker', 'docker', 'infrastructure', 120, 80, '{"backgroundColor":"#2496ed","borderColor":"#2496ed","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"version":"20.10","containers":10,"images":20,"rotation":0}', '1', '1', 17, 'admin', NOW(), 'admin', NOW(), '0', '基础设施-Docker'),
(18, 'firewall', '防火墙', 'SafetyCertificateOutlined', 'security', 120, 80, '{"backgroundColor":"#f5222d","borderColor":"#f5222d","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"type":"iptables","rules":50,"rotation":0}', '1', '1', 18, 'admin', NOW(), 'admin', NOW(), '0', '安全-防火墙'),
(19, 'loadbalancer', '负载均衡', 'ControlOutlined', 'network', 120, 80, '{"backgroundColor":"#722ed1","borderColor":"#722ed1","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"algorithm":"roundRobin","backends":3,"rotation":0}', '1', '1', 19, 'admin', NOW(), 'admin', NOW(), '0', '网络-负载均衡'),
(20, 'oss', '对象存储', 'FolderOpenOutlined', 'storage', 120, 80, '{"backgroundColor":"#13c2c2","borderColor":"#13c2c2","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"type":"MinIO","capacity":"1TB","buckets":10,"rotation":0}', '1', '1', 20, 'admin', NOW(), 'admin', NOW(), '0', '存储-对象存储');
...
-- ----------------------------
INSERT IGNORE INTO `arch_node_type` (`id`, `type_code`, `type_name`, `icon`, `category`, `default_width`, `default_height`, `default_style`, `default_properties`, `is_system`, `is_active`, `sort_order`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES
(21, 'my-panel', 'My-Panel后端服务', 'my-panel', 'application', 120, 80, '{"backgroundColor":"#52c41a","borderColor":"#52c41a","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"java_version":"17","max_memory":"2G","rotation":0}', '1', '1', 21, 'admin', NOW(), 'admin', NOW(), '0', '应用服务-MyPanel'),
(22, 'proxy', 'Proxy代理服务', 'DeploymentUnitOutlined', 'middleware', 120, 80, '{"backgroundColor":"#fa8c16","borderColor":"#fa8c16","borderWidth":2,"borderRadius":4,"color":"#ffffff"}', '{"max_connections":1000,"rotation":0}', '1', '1', 22, 'admin', NOW(), 'admin', NOW(), '0', '中间件-Proxy'),
(23, 'logic-and', '逻辑与 (AND)', 'ApartmentOutlined', 'logic', 100, 60, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff","shape":"logic-and"}', '{"rotation":0}', '1', '1', 23, 'admin', NOW(), 'admin', NOW(), '0', '逻辑形状-与门'),
(24, 'logic-or', '逻辑或 (OR)', 'ApartmentOutlined', 'logic', 100, 60, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff","shape":"logic-or"}', '{"rotation":0}', '1', '1', 24, 'admin', NOW(), 'admin', NOW(), '0', '逻辑形状-或门'),
(25, 'logic-not', '逻辑非 (NOT)', 'ApartmentOutlined', 'logic', 100, 60, '{"backgroundColor":"#1890ff","borderColor":"#1890ff","borderWidth":2,"borderRadius":4,"color":"#ffffff","shape":"logic-not"}', '{"rotation":0}', '1', '1', 25, 'admin', NOW(), 'admin', NOW(), '0', '逻辑形状-非门');
...
(1, 1, 4, 'Nginx-负载均衡服务器', 'nginx-1', 975.00, 50.00, 360, 240, '{"port":80,"ip":"192.168.1.100","config":"worker_processes 4;\nworker_connections 1024;\nkeepalive_timeout 65;"}', 'Nginx', '负载均衡服务器', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(2, 1, 21, 'My-Panel-后端管理服务1', 'mypanel-1', 450.00, 350.00, 360, 240, '{"port":8080,"ip":"192.168.1.101","config":"JAVA_VERSION=17;\nMAX_MEMORY=2G;\nTHREAD_POOL_SIZE=200","rotation":0}', 'My-Panel-1', '后端管理服务1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(3, 1, 21, 'My-Panel-后端管理服务2', 'mypanel-2', 1500.00, 350.00, 360, 240, '{"port":8081,"ip":"192.168.1.102","config":"JAVA_VERSION=17;\nMAX_MEMORY=2G;\nTHREAD_POOL_SIZE=200","rotation":0}', 'My-Panel-2', '后端管理服务2', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(4, 1, 22, 'Proxy-代理服务1', 'proxy-1', 100.00, 650.00, 360, 240, '{"port":9001,"ip":"192.168.1.201","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000"}', 'Proxy-1', '代理服务实例1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(5, 1, 22, 'Proxy-代理服务2', 'proxy-2', 450.00, 650.00, 360, 240, '{"port":9002,"ip":"192.168.1.202","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000","rotation":0}', 'Proxy-2', '代理服务实例2', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(6, 1, 22, 'Proxy-代理服务3', 'proxy-3', 800.00, 650.00, 360, 240, '{"port":9003,"ip":"192.168.1.203","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000"}', 'Proxy-3', '代理服务实例3', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(7, 1, 22, 'Proxy-代理服务4', 'proxy-4', 1150.00, 650.00, 360, 240, '{"port":9004,"ip":"192.168.1.204","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000","rotation":0}', 'Proxy-4', '代理服务实例4', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(8, 1, 22, 'Proxy-代理服务5', 'proxy-5', 1500.00, 650.00, 360, 240, '{"port":9005,"ip":"192.168.1.205","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000"}', 'Proxy-5', '代理服务实例5', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(9, 1, 22, 'Proxy-代理服务6', 'proxy-6', 1850.00, 650.00, 360, 240, '{"port":9006,"ip":"192.168.1.206","config":"REGISTRY_ENABLED=true;\nHEALTH_CHECK_INTERVAL=30;\nMAX_CONNECTIONS=1000","rotation":0}', 'Proxy-6', '代理服务实例6', '0', '1', 'admin', NOW(), 'admin', NOW(), '0');
...
(1, 1, 'default', 1, 2, 'bottom', 'top', 'HTTP请求', '{"stroke":"#1890ff","strokeWidth":3,"strokeDasharray":"8,4"}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(2, 1, 'default', 1, 3, 'bottom', 'top', 'HTTP请求', '{"stroke":"#1890ff","strokeWidth":3,"strokeDasharray":"8,4"}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(3, 1, 'default', 2, 4, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(4, 1, 'default', 2, 5, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(5, 1, 'default', 2, 6, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(6, 1, 'default', 3, 7, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(7, 1, 'default', 3, 8, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0'),
(8, 1, 'default', 3, 9, 'bottom', 'top', '服务调用', '{"stroke":"#52c41a","strokeWidth":2}', '1', '0', '1', 'admin', NOW(), 'admin', NOW(), '0');
