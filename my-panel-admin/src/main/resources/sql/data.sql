...
INSERT IGNORE INTO `sys_job` (
    ...
    `remark`
       ...
       (14, 'sql测试脚本', 'TEST', 'sql测试脚本', 3, NULL, NULL, NULL, NULL, NULL, NULL, 'sql测试脚本', 'sql', 'select * from sys_config where config_id = 1', '0 0 4 * * ?', '3', '1', '1', 'admin', '2026-04-05 10:00:00.0', 'admin', '2026-04-05 10:00:00.0', 'sql测试脚本示例');
