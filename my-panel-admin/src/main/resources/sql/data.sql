...
INSERT IGNORE INTO `sys_job` (
    ...
    `remark`
       ...
       (2, '系统默认（有参）', 'DEFAULT', 'appTask.ryParams(''ry'')', 1, 'appTask.ryParams(''ry'')', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0/15 * * * * ?', '3', '1', '1', 'admin', '2026-02-07 14:13:10.0', 'admin', '2026-02-08 21:09:32.0', ''),
       (3, '系统默认（多参）', 'DEFAULT', 'appTask.ryMultipleParams(''ry'', true, 2000L, 316.50D, 100)', 1, 'appTask.ryMultipleParams(''ry'', true, 2000L, 316.50D, 100)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0/20 * * * * ?', '3', '1', '1', 'admin', '2026-02-07 14:13:10.0', 'admin', '2026-02-08 21:09:14.0', ''),
       ...
       (6, 'HTTP接口调度示例', 'TEST', 'http://localhost:8888/test/user/1', 2, 'getUser', 'http://localhost:8888/test/user/1', 'GET', '{"Content-Type": "application/json"}', '{"id": "{jobId}", "name": "test"}', 'roundRobin', NULL, NULL, NULL, '0/15 * * * * ?', '3', '1', '1', 'admin', '2026-02-07 14:13:10.0', 'admin', '2026-02-08 21:09:32.0', '演示HTTP接口调度'),
       (7, '测试用户列表', 'TEST', 'http://localhost:8888/test/user/list', 2, 'userList', 'http://localhost:8888/test/user/list', 'GET', '{"Content-Type": "application/json"}', NULL, 'roundRobin', NULL, NULL, NULL, '0/30 * * * * ?', '3', '1', '1', 'admin', '2026-04-04 10:00:00.0', 'admin', '2026-04-04 10:00:00.0', '测试获取用户列表接口'),
       (8, '测试用户详情', 'TEST', 'http://localhost:8888/test/user/2', 2, 'getUser', 'http://localhost:8888/test/user/2', 'GET', '{"Content-Type": "application/json"}', '{"userId": "{jobId}"}', 'roundRobin', NULL, NULL, NULL, '0/30 * * * * ?', '3', '1', '1', 'admin', '2026-04-04 10:00:00.0', 'admin', '2026-04-04 10:00:00.0', '测试获取用户详情接口'),
       (9, '测试用户新增', 'TEST', 'http://localhost:8888/test/user/save', 2, 'saveUser', 'http://localhost:8888/test/user/save', 'POST', '{"Content-Type": "application/json"}', '{"userId": "{jobId}", "username": "test", "password": "123456", "mobile": "13800138000"}', 'roundRobin', NULL, NULL, NULL, '0/30 * * * * ?', '3', '1', '1', 'admin', '2026-04-04 10:00:00.0', 'admin', '2026-04-04 10:00:00.0', '测试新增用户接口'),
       (10, '测试用户更新', 'TEST', 'http://localhost:8888/test/user/update', 2, 'updateUser', 'http://localhost:8888/test/user/update', 'PUT', '{"Content-Type": "application/json"}', '{"userId": "{jobId}", "username": "test", "password": "123456", "mobile": "13800138000"}', 'roundRobin', NULL, NULL, NULL, '0/30 * * * * ?', '3', '1', '1', 'admin', '2026-04-04 10:00:00.0', 'admin', '2026-04-04 10:00:00.0', '测试更新用户接口'),
       (11, '测试用户删除', 'TEST', 'http://localhost:8888/test/user/3', 2, 'deleteUser', 'http://localhost:8888/test/user/3', 'DELETE', '{"Content-Type": "application/json"}', '{"userId": "{jobId}"}', 'roundRobin', NULL, NULL, NULL, '0/30 * * * * ?', '3', '1', '1', 'admin', '2026-04-04 10:00:00.0', 'admin', '2026-04-04 10:00:00.0', '测试删除用户接口'),
