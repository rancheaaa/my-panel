...
INSERT IGNORE INTO `sys_job` (
    ...
    `remark`
       ...
       (3, '调用内置方法（多参）', 'DEFAULT', 'appTask.runMultipleParams("hello", true, 2000L, 316.50D, 100)', 1, 'appTask.runMultipleParams("hello", true, 2000, 316.50, 100)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0/20 * * * * ?', '3', '1', '1', 'admin', '2026-02-07 14:13:10.0', 'admin', '2026-02-08 21:09:14.0', '调用内置方法（有参）'),
