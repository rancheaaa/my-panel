...
INSERT IGNORE INTO `sys_menu` VALUES
        ...
        (3, '注册配置中心', 0, 4, 'registry-config-center', NULL, '', '', 1, 0, 'M', '0', '0', '', 'ThunderboltOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-02-13 09:48:49.545433', '注册配置中心目录'),
        ...
        (103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', '', 1, 0, 'C', '0', '0', 'system:dept:list', 'ContactsOutlined', 'admin', '2026-02-07 14:13:09.0', '', NULL, '部门管理菜单'),
        ...
        (106, '参数设置', 1, 7, 'config', 'system/config/index', '', '', 1, 0, 'C', '0', '0', 'system:config:list', 'ControlOutlined', 'admin', '2026-02-07 14:13:09.0', '', NULL, '参数设置菜单'),
        ...
        (108, '日志管理', 2, 9, 'log', '', '', '', 1, 0, 'M', '0', '0', '', 'FilterOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-02-07 17:42:08.0', '日志管理菜单'),
        ...
        (114, '缓存列表', 2, 6, 'cacheList', 'monitor/cacheList/index', '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'OrderedListOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-02-08 16:46:53.0', '缓存列表菜单'),
        (115, '配置中心', 3, 2, 'config-center', 'rc/configCenter/index', '', '', 1, 0, 'C', '0', '0', 'rc:configCenter:list', 'FileOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-03-27 18:46:31.008615', '表单构建菜单'),
        (116, '应用管理', 3, 4, 'app-manage', 'rc/appManage/index', '', '', 1, 0, 'C', '0', '0', 'rc:appManage:list', 'AppstoreOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-03-27 18:46:31.011183', '代码生成菜单'),
        (117, '注册中心', 3, 1, 'swagger', 'rc/registryCenter/index', '', '', 1, 0, 'C', '0', '0', 'rc:registryCenter:list', 'PhoneOutlined', 'admin', '2026-02-07 14:13:09.0', 'admin', '2026-03-27 18:46:31.007147', '系统接口菜单'),
        ...
        (2000, '环境管理', 3, 3, 'env-manage', 'rc/envManage/index', NULL, '', 1, 0, 'C', '0', '0', 'rc:envManage:list', 'EnvironmentOutlined', 'admin', '2026-02-13 09:56:15.041545', 'admin', '2026-03-27 18:46:31.008615', ''),
        ...
        (2012, 'Agent连通性', 1500, 3, 'agentConnectivity', 'op/agentConnectivity/index', NULL, '', 1, 0, 'C', '0', '0', 'op:agentConnectivity:check', 'ApiOutlined', 'admin', NOW(), '', NULL, 'Agent连通性检测'),
        (2013, '连通性检测', 2012, 1, '#', '', '', '', 1, 0, 'F', '0', '0', 'op:agentConnectivity:check', '#', 'admin', NOW(), '', NULL, ''),
        (2014, '目录检测', 1500, 4, 'dirCheck', 'op/dirCheck/index', NULL, '', 1, 0, 'C', '0', '0', 'op:dirCheck:query', 'FolderOpenOutlined', 'admin', NOW(), '', NULL, '目录检测页面'),
        (2015, '目录检测查询', 2014, 1, '#', '', '', '', 1, 0, 'F', '0', '0', 'op:dirCheck:query', '#', 'admin', NOW(), '', NULL, ''),
        (2200, '报警规则管理', 2, 10, 'alert-rule-manage', 'monitor/alertRuleManage/index', NULL, '', 1, 0, 'C', '0', '0', 'monitor:alertRule:list', 'AlertOutlined', 'admin', NOW(), '', NULL, '报警规则管理'),
        (2201, '规则新增', 2200, 1, '#', '', '', '', 1, 0, 'F', '0', '0', 'monitor:alertRule:add', '#', 'admin', NOW(), '', NULL, ''),
        (2202, '规则修改', 2200, 2, '#', '', '', '', 1, 0, 'F', '0', '0', 'monitor:alertRule:edit', '#', 'admin', NOW(), '', NULL, ''),
        (2203, '规则删除', 2200, 3, '#', '', '', '', 1, 0, 'F', '0', '0', 'monitor:alertRule:remove', '#', 'admin', NOW(), '', NULL, ''),
        (2204, '告警事件查询', 2200, 4, '#', '', '', '', 1, 0, 'F', '0', '0', 'monitor:alertEvent:query', '#', 'admin', NOW(), '', NULL, ''),
        (2100, '架构编排', 0, 6, 'architecture', NULL, '', '', 1, 0, 'M', '0', '0', '', 'ApartmentOutlined', 'admin', NOW(), '', NULL, '架构编排目录'),
        (2101, '架构图管理', 2100, 1, 'arch-diagram', 'arch/architectureList/index', '', '', 1, 0, 'C', '0', '0', 'arch:diagram:list', 'PictureOutlined', 'admin', NOW(), '', NULL, '架构图管理菜单'),
        (2102, '节点类型管理', 2100, 2, 'arch-node-type', 'arch/architectureNodeType/index', '', '', 1, 0, 'C', '0', '0', 'arch:nodeType:list', 'PushpinOutlined', 'admin', NOW(), '', NULL, '节点类型管理菜单'),
        ...
        (2103, '节点标签管理', 2100, 3, 'arch-tag', 'arch/architectureTag/index', '', '', 1, 0, 'C', '0', '0', 'arch:tag:list', 'TagOutlined', 'admin', NOW(), '', NULL, '节点标签管理菜单'),
