...
class ProgressReceiverControllerTest {
        ...
        void testReceiveProgress_success() throws Exception {
                doNothing().when(progressService).updateProgressExt(anyLong(), anyInt(), anyInt(), anyLong(),
                                anyLong());
        ...
        void testReceiveComplete_finalStateSet() throws Exception {
                ...
                verify(progressService)
                                .updateSubTaskStatus(argThat(subtask -> subtask.getStatus().equals("COMPLETED") &&
                                                subtask.getTargetPath().equals("/backup/file.txt")));
        ...
        void testReceiveFailed_errorInfoRecorded() throws Exception {
                ...
                verify(progressService).updateSubTaskStatus(argThat(subtask -> subtask.getStatus().equals("FAILED") &&
                                subtask.getErrorCode().equals("CONNECTION_TIMEOUT") &&
                                subtask.getErrorMessage().equals("Agent unreachable after 30s")));
        ...
        void testReceiveStatus_agentCompletedWithDateFormat_success() throws Exception {
                ...
                verify(progressService).updateSubTaskStatus(argThat(subtask -> subtask.getStartedAt() != null &&
