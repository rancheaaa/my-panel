                            ...
                            <div className="metric-content">
                                <div className="metric-list">
                                    ...
                                    <div className="metric-item">
                                        ...
                                        <span
                                            className={`metric-value ${cpu?.used > 80 ? 'warning' : 'success'}`}>{cpu?.used}%</span>
                                    </div>
                                    <div className="metric-item">
                                        <span className="metric-label">系统使用率</span>
                                        <span
                                            className={`metric-value ${cpu?.sys > 80 ? 'warning' : 'success'}`}>{cpu?.sys}%</span>
                                    </div>
                                    <div className="metric-item">
                            ...
                            <div className="metric-content">
                                <div className="metric-list">
                                    ...
                                    <div className="metric-item">
                                        ...
                                        <span
                                            className={`metric-value ${mem?.usage > 80 ? 'warning' : 'success'}`}>{mem?.usage}%</span>
                                    </div>
                                </div>
                                <div className="metric-ring">
                                    <Progress
                            ...
                            <div className="metric-content">
                                <div className="metric-list">
                                    ...
                                    <div className="metric-item">
                                        ...
                                        <span
                                            className={`metric-value ${jvm?.usage > 80 ? 'warning' : 'success'}`}>{jvm?.usage}%</span>
                                    </div>
                                </div>
                                <div className="metric-ring">
                                    <Progress
                                        ...
                                        <div className="kernel-resource-detail">
                                            ...
                                            <div className="kernel-detail-grid">
                                                <div className="kernel-detail-item">
                                                    ...
                                                    <span
                                                        className="kd-value">{processMemory.kernelResource.openFileDescriptors} 个</span>
                                                    <span
                                                        className="kd-size">{processMemory.kernelResource.fileDescriptorMb} MB</span>
                                                </div>
                                                <div className="kernel-detail-item">
                                                    <span className="kd-label">Socket缓冲区</span>
                                                    <span
                                                        className="kd-value">{processMemory.kernelResource.socketCount} 个</span>
                                                    <span
                                                        className="kd-size">{processMemory.kernelResource.socketBufferMb} MB</span>
                                                </div>
                                                <div className="kernel-detail-item">
                                                    <span className="kd-label">内存映射文件</span>
                                                    <span
                                                        className="kd-value">{processMemory.kernelResource.mappedFileCount} 个</span>
                                                    <span
                                                        className="kd-size">{processMemory.kernelResource.mappedFileMb} MB</span>
                                                </div>
                                                <div className="kernel-detail-item">
                                                    <span className="kd-label">共享内存</span>
                                                    <span className="kd-value">-</span>
                                                    <span
                                                        className="kd-size">{processMemory.kernelResource.sharedMemoryMb} MB</span>
                                                </div>
                                                <div className="kernel-detail-item">
                                                    <span className="kd-label">页表占用</span>
                                                    <span className="kd-value">-</span>
                                                    <span
                                                        className="kd-size">{processMemory.kernelResource.pageTableMb} MB</span>
                                                </div>
                                                <div className="kernel-detail-item kernel-detail-total">
                                                    <span className="kd-label">内核资源合计</span>
                                                    <span className="kd-value"></span>
                                                    <span
                                                        className="kd-size kd-total-size">{processMemory.kernelResource.totalKernelMb} MB</span>
                                                </div>
                                            </div>
                                        </div>
                                    )}
