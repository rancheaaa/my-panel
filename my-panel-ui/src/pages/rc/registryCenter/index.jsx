...
import { Table, Card, Button, Space, Form, Input, Modal, message, Popconfirm, Tooltip, Select, Tag, Dropdown, Row, Col, InputNumber, Pagination } from 'antd';
...
const RegistryCenter = () => {
  ...
  return (
    <div className="registry-center-page-container">
      ...
      <Card bordered={false} className="table-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minHeight: 0 }}>
        ...
        <div className="registry-center-table-container">
          <Table
            rowSelection={{
              selectedRowKeys,
